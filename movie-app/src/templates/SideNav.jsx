...
function SideNav() {
  return (
   <div className='max-w-[20%] h-full  border-r-[1px] border-zinc-500 text-zinc-400 py-5 px-8'>
    ...
    <Link className="px-4 py-3 rounded hover:bg-[#6556cd] duration-300 hover:text-white"><i className="mr-1 ri-fire-fill"></i>Trending</Link>
    <Link className="px-4 py-3 rounded hover:bg-[#6556cd] duration-300 hover:text-white"><i className="mr-2 ri-bard-fill"></i>Popular</Link>
