...
import { clearMovieInfo } from "../store/reducers/movieSlice";
import Loading from "./Loading";
import noImage from "../../src/assets/blank-person.webp";
...
function MovieDetails() {
 ...
 {info.recommendations.length > 0 && ( <h1 className="font-bold text-2xl mt-3 mb-4">Recommendations & Similar Movies :</h1>
 ) }
