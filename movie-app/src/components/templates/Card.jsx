...
function Card({ data }) {
  ...
  <div className="min-w-[20%] h-[50vh]  flex flex-col bg-zinc-900 cursor-pointer hover:scale-105 duration-300">
     ...
     <div className="w-full h-[40%] p-2">
      <h1 className="text-white text-lg tracking-normal leading-tight font-bold hover:text-[#6556cd] duration-200 ">{data.name &&  data.name.slice(0,25)  || data.title && data.title.slice(0,25)   || data.original_name && data.original_name.slice(0,25) }</h1>
